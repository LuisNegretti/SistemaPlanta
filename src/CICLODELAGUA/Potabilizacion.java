 ...
 * @author pc
 */
public class Potabilizacion extends javax.swing.JFrame {

    /**
     * Creates new form Potabilizacion
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENGRANDES/potabilizacion.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Potabilizacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Potabilizacion().setVisible(true);
            }
        });
    }
