 ...
 * @author pc
 */
public class ciclo6 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        precipitacion.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        precipitacion.setForeground(new java.awt.Color(0, 102, 0));
        precipitacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos ciclo del agua/water_5625899.png"))); // NOI18N
        precipitacion.setText("Que es la precipitacion?");
        ...
        jPanel1.add(precipitacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 480, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENGRANDES/ciclo del agua6.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ciclo6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
