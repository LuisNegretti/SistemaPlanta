 ...
 * @author pc
 */
public class Agua3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(condensacion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 70, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENGRANDES/agua3.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agua3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
