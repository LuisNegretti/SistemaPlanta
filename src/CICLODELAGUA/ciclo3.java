 ...
 * @author pc
 */
public class ciclo3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        evaporacion.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        evaporacion.setForeground(new java.awt.Color(0, 255, 255));
        evaporacion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconos ciclo del agua/cycle2.png"))); // NOI18N
        evaporacion.setText("Que es la evaporacion?");
        ...
        jPanel1.add(evaporacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 480, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMAGENGRANDES/ciclo del agua3.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ciclo3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
